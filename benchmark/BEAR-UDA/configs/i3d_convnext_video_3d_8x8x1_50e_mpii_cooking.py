...
data_root = proj_dir + 'BEAR/datasets/MPII-Cooking/frames/'
data_root_val = proj_dir + 'BEAR/datasets/ToyotaSmarthome/frames/'
ann_file_train = proj_dir + 'BEAR/benchmark/BEAR-UDA/data/toyota_smarthome_mpii_cooking/mpii_cooking_da_train.csv'
ann_file_test = proj_dir + 'BEAR/benchmark/BEAR-UDA/data/toyota_smarthome_mpii_cooking/toyota_smarthome_da_test.csv'
img_norm_cfg = dict(
